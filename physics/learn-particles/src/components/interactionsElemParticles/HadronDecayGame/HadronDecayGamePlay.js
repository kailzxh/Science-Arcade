    ...
    return (
        <div>
            ...
            <div className="hadron-game-container">
                <div >
                <p>You need {hadron[0] === "Κ" || hadron[0] === "π" ? 2 : 3} quarks</p>
<p>Selected:</p>
                    ...
                    {hasCompletedFirstStage &&
                        ...
                        {wrongChoice && !hasCompletedFirstStage && <p>Select another quark particle</p>}
{hasCompletedFirstStage && <p>You have correctly completed all the quarks</p>}
